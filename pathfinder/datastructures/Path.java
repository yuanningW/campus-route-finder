...
public class Path<E> implements Iterable<Path<E>.Segment>{
    ...
    //      each "step" along the path between start and end => elements of list path, where
    //          path.get(0) is the first step from the start to an intermediate , and
    ...
    /**
     * The ordered sequence of segments representing a path between start and end.
     */
     ...
     *
     * @param start The starting of the path.
     */
    public Path(E start) {
        this.start = start;
        this.cost = 0;
    ...
    /**
     * Appends a new single segment to the end of this path, originating at the current last end
     ...
     * segmentCost}.
     *
     * @param newEnd      The new segment start being added at the end of the segment being appended to this path
    ...
    /**
     * Return the start of the path. Do not modify the returned object.
     ...
     * to the end. In the case that this path represents a path between
    ...
    /**
     * Segment represents a single segment as part of a longer, more complex path between start and end.
    ...
    public class Segment {
         ...
         *
         * @param start The of this segment.
         * @param end   The of this segment.
        ...
        /**
         * Return the start of the segment. Do not modify the returned object.
         * @return The beginning of this segment.
         */
        public E getStart() {
            // this object should not be modified after returning
            return this.start;
        }

        /**
         * Return the end of the segment. Do not modify the returned object.
